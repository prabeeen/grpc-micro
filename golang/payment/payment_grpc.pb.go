...
type PaymentClient interface {
	Create(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CreatePaymentReply, error)
}
...
func (c *paymentClient) Create(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CreatePaymentReply, error) {
...
type PaymentServer interface {
	Create(context.Context, *CreatePaymentRequest) (*CreatePaymentReply, error)
...
func (UnimplementedPaymentServer) Create(context.Context, *CreatePaymentRequest) (*CreatePaymentReply, error) {
